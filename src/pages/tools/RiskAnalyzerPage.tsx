...
const RiskAnalyzerPage = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const prompt = `Analyze the following contract/agreement for potential legal risks, unfavorable clauses, missing protections, and compliance issues. Provide a risk score (Low/Medium/High), list specific risks, and suggest improvements:\n\n${contractText}`;

            const data = await generateLegalContent(prompt, "You are a senior legal counsel specializing in contract review and risk management. Provide a thorough and critical analysis of the provided legal document.");
            setResult(data);
        } catch (error) {
