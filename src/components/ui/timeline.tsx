...
export const Timeline = ({ 
  data,
  title = "Our Journey",
  description = "From concept to the most advanced legal AI assistant for Indian Law."
}: { 
  data: TimelineEntry[],
  title?: string,
  description?: string
    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-700 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_100%,transparent_100%)] "
        >
          <motion.div
            style={{
